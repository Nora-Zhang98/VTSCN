...
_C.MODEL.PRETRAINED_DETECTOR_CKPT_VG = "/home/stormai/userfile/zrn/detector_ckpt/model_final.pth"
_C.MODEL.PRETRAINED_DETECTOR_CKPT_GQA = "/home/stormai/userfile/zrn/detector_ckpt/gqa_model_final_from_vg.pth" #datasets_path+\
...
_C.MODEL.ROI_RELATION_HEAD.TRI_TRANSFORMER = CN()
_C.MODEL.ROI_RELATION_HEAD.TRI_TRANSFORMER.DROPOUT_RATE = 0.1
_C.MODEL.ROI_RELATION_HEAD.TRI_TRANSFORMER.LAYER = 2
_C.MODEL.ROI_RELATION_HEAD.TRI_TRANSFORMER.NUM_HEAD = 8
_C.MODEL.ROI_RELATION_HEAD.TRI_TRANSFORMER.INNER_DIM = 2048
_C.MODEL.ROI_RELATION_HEAD.TRI_TRANSFORMER.KEY_DIM = 64
_C.MODEL.ROI_RELATION_HEAD.TRI_TRANSFORMER.VAL_DIM = 64
